...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final HealthLibraryAccessors laccForHealthLibraryAccessors = new HealthLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>adaptive</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    ...
    /**
     * Group of libraries at <b>health</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public HealthLibraryAccessors getHealth() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForHealthLibraryAccessors;
    }
    ...
    public static class AdaptiveLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getNavigation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("adaptive.navigation");
        }
     ...
     */
    @Deprecated
    public static class HealthLibraryAccessors extends SubDependencyFactory {

        public HealthLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>connect</b> with <b>androidx.health.connect:connect-client</b> coordinates and
         * with version reference <b>health.connect</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>adaptive</b> with value <b>1.0.0</b>
         * <p>
    ...
    public static class HealthVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>health.connect</b> with value <b>1.1.0-rc02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getConnect() { return getVersion("health.connect"); }
